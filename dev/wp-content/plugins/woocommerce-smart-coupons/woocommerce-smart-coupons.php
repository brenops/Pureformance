...
if ( is_woocommerce_active() ) {
        ...
        class WC_Smart_Coupons {
            ...
            public function __construct() {
                ...
                add_action( 'init', array( &$this, 'apply_coupon_from_url' ) );
            ...
            function sc_modify_renewal_order( $order_items, $original_order_id, $renewal_order_id, $product_id, $new_order_role ) {
            ...
            public function woocommerce_cart_item_price_html( $product_price, $cart_item, $cart_item_key ) {
                ...
                global $woocommerce;
                $gift_certificate = $woocommerce->session->credit_called;
            ...
            function apply_coupon_from_url() {
                ...
                if( isset( $coupon_args['coupon-applied'] ) ) {
                    return;
                }

                if( isset( $coupon_args['coupon-code'] ) && ! empty( $coupon_args['coupon-code'] ) ) {

                    $woocommerce->cart->add_discount( trim( $coupon_args['coupon-code'] ) );
                    ...
                    if( ! empty( $coupon_args['sc-page'] ) ) {
                        ...
                        wp_safe_redirect( $_SERVER['REQUEST_URI']."&coupon-applied" );
                    }
            ...
            function get_expiration_format( $expiry_date ) {
            ...
            function ppe_save_called_credit_details_in_order( $order ) {
            ...
            function smart_coupons_after_wp_tiny_mce( $mce_settings ) {
                if ( !isset( $mce_settings['content']['plugins'] ) ) return;
                        ...
                        jQuery(function(){
                            jQuery('input#search-coupon-field').on('keyup',function() {
                                ...
                                if ( searchString.length == 0 ) {
                                    jQuery('#default-text').html('<?php _e( "No search term specified." ); ?>');
                                    return true;
                                }
                                if ( searchString.length == 1 ) {
                                    jQuery('#default-text').html('<?php _e( "Enter more than one character to search." ); ?>');
                                    return true;
                                }
                                ...
                                jQuery.ajax({
                                    ...
                                    success: function( response ) {
                                        if ( response ) {
                                            jQuery('#default-text').html('<?php _e( "Click to select coupon code." ); ?>');
                                        } else {
                                            jQuery('#default-text').html('<?php _e( "No coupon code found." ); ?>');
                                            return;
                                        }
                            ...
                            <div id="coupon-option">
                                ...
                                <div id="search-panel">
                                    <div id="search-results">
                                        <div id="default-text"><?php _e( 'No search term specified.' ); ?></div>
                                        <ul></ul>
                                    </div>
                                </div>
                                <div>
                    ...
                    $smart_coupon_store_gift_page_text = ( !empty( $smart_coupon_store_gift_page_text ) ) ? $smart_coupon_store_gift_page_text.' ' : 'Purchase Credit worth';
                                ...
                                <div id="call_for_credit">
                                    ...
                                    <?php
                                        ...
                                        echo '</p><br /><br />';
                                        echo "<input id='credit_called' step='any' type='number' min='1' name='credit_called' value='' autocomplete='off' />";
                                    ?>
            ...
            function show_available_coupons_after_cart_table() {
                ...
                if ( $this->show_available_coupons() ) {
                    ...
                    $woocommerce->add_inline_js("
                        ...
                        jQuery('div.apply_coupons_credits').on('click', function() {
            ...
            function show_available_coupons() {
                                global $woocommerce;
								$smart_coupon_cart_page_text = get_option('smart_coupon_cart_page_text', __( 'Available Coupons (Click on the coupon to use it)', 'wc_smart_coupons' ));

                $global_coupons = $this->get_global_coupons();

                if ( !is_user_logged_in() && empty( $global_coupons ) ) return false;
                ...
                if ( empty( $coupons ) ) return false;
                    ...
                    <div id='coupons_list'><h2><?php _e( stripslashes( $smart_coupon_cart_page_text ), 'wc_smart_coupons' ) ?></h2>
                        ...
                        foreach ( $coupons as $code ) {
                            ...
                            if( empty( $coupon->amount ) || $coupon->amount == 0 )
                                continue;
            ...
            function add_gift_certificate_receiver_details_in_order( $order_id ) {
                ...
                if ( isset( $_REQUEST['gift_receiver_email'] ) || ( isset( $_REQUEST['billing_email'] ) && $_REQUEST['billing_email'] != $_REQUEST['gift_receiver_email'] ) ) {
                    ...
                    if ( isset( $_REQUEST['is_gift'] ) && $_REQUEST['is_gift'] == 'yes' ) {
                        ...
                        if ( isset( $_REQUEST['gift_receiver_email'][0][0] ) ) {
                            unset( $_REQUEST['gift_receiver_email'][0][0] );
                            foreach ( $_REQUEST['gift_receiver_email'] as $coupon_id => $emails ) {
                                foreach ( $emails as $key => $email ) {
                    ...
                    if($coupon_amount != '' || $coupon_amount > 0) {
						...
						<div class="form_table">
                            <div class="email_amount">
                                ...
                                <div class="email"><input class="gift_receiver_email" type="text" placeholder="<?php _e( 'Email address', 'wc_smart_coupons' ); ?>..." name="gift_receiver_email[<?php echo $coupon->id; ?>][]" value="<?php echo ggReceiverEmail() ?>" /></div>
                            </div>
                            <div class="message_row">
                                <div class="sc_message"><textarea placeholder="<?php _e('Message', 'wc_smart_coupons'); ?>..." class="gift_receiver_message" name="gift_receiver_message[<?php echo $coupon->id; ?>][]" cols="50" rows="5"><?php echo ggReceiverMessage() ?></textarea></div>
                            </div>
                        </div>
                        <?php
                    }
                    ...
                    <div id="gift-certificate-receiver-form-single">
                        <div class="form_table">
                            <div class="email_amount">
                                ...
                                <div class="email"><input class="gift_receiver_email" type="text" placeholder="<?php _e( 'Email address', 'wc_smart_coupons' ); ?>..." name="gift_receiver_email[0][0]" value="<?php echo ggReceiverEmail() ?>" /></div>
                            </div>
                            <div class="message_row">
                                <div class="message"><textarea placeholder="<?php _e('Message', 'wc_smart_coupons'); ?>..." class="gift_receiver_message" name="gift_receiver_message[0][0]" cols="50" rows="5"><?php echo ggReceiverMessage() ?></textarea></div>
                            </div>
                        </div>
                    </div>
                    </div></div>
            ...
            function show_attached_gift_certificates() {
                ...
                if ( $coupon_titles && count( $coupon_titles ) > 0 && !empty( $price ) ) {
                    ...
                    $smart_coupons_product_page_text = ( !empty( $smart_coupons_product_page_text ) ) ? $smart_coupons_product_page_text : 'By purchasing this product, you will get following coupon(s):';
					...
					<h2><?php _e( stripslashes ( $smart_coupons_myaccount_page_text ), 'wc_smart_coupons' ); ?></h2>
                        ...
                        foreach ( $coupons as $code ) {
                            ...
                            $coupon_data = $this->get_coupon_meta_data( $coupon );
                               ...
                               echo '<div class="coupon-container apply_coupons_credits blue medium">
                            ...
                            jQuery(function(){
                                ...
                                jQuery('div.apply_coupons_credits').on('click', function() {
		                            ...
		                            if( coupon_code != '' && coupon_code != undefined ) {
		                                ...
		                                var url = '". home_url() ."?sc-page=shop&coupon-code='+coupon_code;   
            ...
            function woocommerce_product_options_coupons() {
                ...
                <?php
                    ...
                    <script type="text/javascript">
                        ...
                        jQuery('select#_coupon_title').on('change', function(){
                            setTimeout( function() {
                                updateSendCouponOnRenewals();
                            }, 10 );
                        });
            ...
            function woocommerce_process_product_meta_coupons( $post_id, $post ) {
            ...
            function process_coupons( $order_id, $operation ) {
                        ...
                        if ( $coupon_titles ) {
                            ...
                            if ( $this->is_coupon_amount_pick_from_product_price( $coupon_titles ) && $product->get_price() <= 0 ) {
                                $item['sc_called_credit'] = $sc_called_credit_details[$item_id];
                                                    ...
                                                    if ( $operation == 'add' && !empty( $receivers_emails ) ) {
                ...
                if ( ( count( $receivers_detail ) + $receiver_count ) > 0 ) {
                    $this->acknowledge_gift_certificate_sender( $receivers_detail, $gift_certificate_receiver_name, $email, $gift_certificate_sender_email, ( count( $receivers_detail ) + $receiver_count ) );
                }
            ...
            function acknowledge_gift_certificate_sender( $receivers_detail = array(), $gift_certificate_receiver_name = '', $email = '', $gift_certificate_sender_email = '', $receiver_count = '' ) {
            ...
            function sa_email_coupon( $coupon_title, $discount_type, $order_id = '', $gift_certificate_receiver_name = '', $message_from_sender = '', $gift_certificate_sender_name = '', $gift_certificate_sender_email = '', $is_gift = '' ) {
                global $woocommerce;
            ...
            function get_global_coupons() {
                ...
                <div class="tool-box">
                    ...
                    <form action="<?php echo admin_url('admin.php?page=woocommerce_coupon_csv_import&action=sent_gift_certificate'); ?>" method="post">
                        ...
                        <table class="form-table">
                            <tr>
                                ...
                                <td>
                                    <input type="number" min="0" step="any" name="smart_coupon_amount" id="amount" placeholder="<?php _e('0.00', 'wc_smart_coupons'); ?>" class="input-text" />
                                </td>
                                                                <td>
                                                                    <?php
                    ...
                    jQuery(function(){
                                ...
                                jQuery('div#message p').html( "<?php echo __('Please enter a valid value for Number of Coupons to Generate', 'wc_smart_coupons'); ?>");
                                                    return false;
                                                } else {
                        ...
                        <div class="panel woocommerce_options_panel">
                            <div class="option_group">
                                ...
                                <p class="form-field">
                                    ...
                                    <input type="number" name="sc_minimum_amount" id="sc_minimum_amount" min="0" step="any" />
                                ...
                                <p class="form-field">
                                    ...
                                    <input type="number" name="sc_usage_limit" id="sc_usage_limit" min="0" />
