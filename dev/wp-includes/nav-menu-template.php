...
class Walker_Nav_Menu extends Walker {
	...
	function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		$description = get_post_meta($item->ID, 'menu-description', true);
		
		$item_output = $args->before;
		$item_output .= '<a'. $attributes .'>';
		$item_output .= $args->link_before . apply_filters( 'the_title', $item->title, $item->ID ) . $args->link_after.'<span>Lorem ipsum dolor sit amet, consectetur libero enim adipiscing elit.'.$description.'</span>';
		$item_output .= '</a>';
