				...
				<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<?php
						...
						while (have_posts()) : the_post();
							...
							$modi = $x%2;
					?>
                    	<a href="<?php echo home_url( '/' ); ?>our-store/products-details/" class="products<?php if($modi == 1) { echo ' odd'; } else { echo ' even'; } ?>" style="background:url(<?php bloginfo( 'template_directory' ); ?>/images/<?php echo $prod_img ?>) no-repeat;">
                        	<div class="non-over">
								<h2><?php the_title(); ?></h2>
