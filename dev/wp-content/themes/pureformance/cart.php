...
<?php //GENERATE FORM HERE BECAUSE YOU CANT HAVE A FORM WITHIN ANOTHER FORM.
			if($blog_purchase==false) //means no blog is subscribed
			{
				$blog_prod = new WC_Product(213); //pass the id to the constructor
				?>
					<tr>
						<td colspan="6">
							...
							<form enctype="multipart/form-data" method="post" class="cart" action="/pureformance/shop/blog-subscription/?add-to-cart=213">
	 							...
	 							<button class="single_add_to_cart_button button alt" type="submit">Yes, add subscription to my cart</button>
	 						</form>
						</td>
					</tr>
				<?php
